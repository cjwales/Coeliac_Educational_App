<template lang="html">
  <div class="nav">
    <nav>
      <router-link class="nav-button button-1" :to="{ name: 'home'}">Home</router-link>
      ...
      <router-link class="nav-button button-5" :to="{ name: 'login'}">AdminLogin</router-link>
